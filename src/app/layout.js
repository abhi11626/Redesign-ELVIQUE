...
export const metadata = {
  ...
  description:
    "Apparel-led direct selling platform focused on product discovery, distributor onboarding, campaign growth, and future commerce experiences.",
  icons: {
    icon: "/logo.webp",
  },
};
...
export default function RootLayout({ children }) {
  return (
    ...
    >
      <body className="min-h-screen flex flex-col bg-[#fafafa] text-gray-900 dark:text-gray-100 overflow-x-hidden">
        <Navbar />
